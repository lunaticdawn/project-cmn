package com.project.cmn.gen.common.service;
...
public class MakeContentService {
    ...
    protected String getDtoContent(FileInfoDto fileInfoDto, List<CommonColumnDto> columnsList) {
        ...
        for (CommonColumnDto commonColumnDto : columnsList) {
            buff.append(BLANK_4).append("/**").append("\n");
            buff.append(BLANK_4).append(" * ").append(commonColumnDto.getColumnComment()).append("\n");
            buff.append(BLANK_4).append(" */").append("\n");
            buff.append(BLANK_4).append("@JsonProperty(\"").append(commonColumnDto.getColumnName().toLowerCase()).append("\")").append("\n");
            buff.append(BLANK_4).append("private ").append(commonColumnDto.getJavaDataType().getType()).append(" ").append(CaseUtils.toCamelCase(commonColumnDto.getColumnName(), false, '_')).append(";").append("\n");
            buff.append("\n");
        }
    ...
    private String getSelectStatement(FileInfoDto fileInfoDto, List<CommonColumnDto> columnsList, String tableName) {
        ...
        builder.append(BLANK_8).append("SELECT\n");
        ...
        builder.append(BLANK_8).append("FROM\n");
        builder.append(BLANK_12).append(tableName).append("\n");
        builder.append(BLANK_8).append("WHERE\n");
    ...
    private String getInsertStatement(FileInfoDto fileInfoDto, List<CommonColumnDto> columnsList, String tableName) {
        ...
        builder.append(BLANK_8).append("INSERT INTO ").append(tableName).append(" (\n");
        ...
        builder.append(BLANK_8).append(") VALUES (\n");
    ...
    private String getUpdateStatement(FileInfoDto fileInfoDto, List<CommonColumnDto> columnsList, String tableName) {
        ...
        builder.append(BLANK_8).append("UPDATE ").append(tableName).append("\n");
        builder.append(BLANK_8).append("<set>\n");
    ...
    private String wrapQuery(String type, FileInfoDto fileInfoDto, String query) {
        ...
        builder.append(BLANK_8).append("/* ").append(fileInfoDto.getMapperNamespace()).append(".").append(type).append(fileInfoDto.getBasicFilename()).append(" */\n");
    ...
    private String getConditionClause(FieldPosition fieldPosition, CommonColumnDto commonColumnDto) {
        ...
        if (commonColumnDto.getJavaDataType() == JavaDataType.STRING) {
            builder.append(BLANK_12).append("<if test=\"@org.apache.commons.lang3.StringUtils@isNotBlank(").append(commonColumnDto.getFieldName()).append(")\">\n");
        } else {
            builder.append(BLANK_12).append("<if test=\"").append(commonColumnDto.getFieldName()).append(" != null").append("\">\n");
        }

        if (fieldPosition == FieldPosition.INSERT_FIELD) {
            builder.append(BLANK_16).append(", ").append(commonColumnDto.getColumnName()).append("\n");
        }

        if (fieldPosition == FieldPosition.INSERT_VALUE) {
            builder.append(BLANK_16).append(", ").append("#{").append(commonColumnDto.getFieldName()).append("}").append("\n");
        }

        if (fieldPosition == FieldPosition.UPDATE_SET
                || fieldPosition == FieldPosition.WHERE) {
            builder.append(BLANK_16);
        ...
        builder.append(BLANK_12).append("</if>");
